...
const predefinedQueries = [
  { id: 1, name: "List all scientists with their departments, specialization names and gender", category: "Scientists" },
  { id: 2, name: "Show scientists, the equipment assigned to them, and the assignment date", category: "Equipment" },
  { id: 3, name: "All equipment with the supplier details", category: "Suppliers" },
  { id: 4, name: "Materials and supplier name", category: "Suppliers" },
  { id: 5, name: "Scientists with their full profile", category: "Scientists" },
  { id: 6, name: "All equipment used in the Physics department", category: "Equipment" },
  { id: 7, name: "Suppliers who supply both equipment and materials", category: "Suppliers" },
  { id: 8, name: "Equipment assignments", category: "Equipment" },
  { id: 9, name: "All assignments with the scientist name and equipment name", category: "Equipment" },
  { id: 10, name: "Material requests with scientist names, department name, quantity and request date", category: "Materials" },
  { id: 11, name: "Purchases with the supplier names, material names, quantity and purchase date", category: "Purchases" },
  { id: 12, name: "All departments and their specializations", category: "Departments" },
  { id: 13, name: "Purchases and material cost", category: "Purchases" },
  { id: 14, name: "Departments with their scientists and equipment", category: "Equipment" },
  { id: 15, name: "All suppliers located in Nairobi and what they supply", category: "Suppliers" },
  { id: 16, name: "Count the number of scientists per department", category: "Scientists" },
  { id: 17, name: "Count the number of equipment per department", category: "Equipment" },
  { id: 18, name: "Find average age of scientists per department", category: "Scientists" },
  { id: 19, name: "Count how many materials each supplier provides", category: "Suppliers" },
  { id: 20, name: "Find total cost of equipment in each department", category: "Equipment" },
  { id: 21, name: "Count number of assignments per scientist", category: "Equipment" },
  { id: 22, name: "Find most requested material", category: "Materials" },
  { id: 23, name: "Count purchases for each supplier", category: "Purchases" },
  { id: 24, name: "Find total material quantities requested", category: "Materials" },
  { id: 25, name: "Average material request quantity", category: "Materials" },
  { id: 26, name: "Count scientists per gender", category: "Scientists" },
  { id: 27, name: "Count specializations per department", category: "Departments" },
  { id: 28, name: "Departments with more than 5 scientists", category: "Scientists" },
  { id: 29, name: "Suppliers who supply more than 3 materials", category: "Suppliers" },
  { id: 30, name: "Scientists with more than 1 equipment assigned", category: "Equipment" },
  { id: 31, name: "Materials requested more than 10 times", category: "Materials" },
  { id: 32, name: "Departments with average age above 40", category: "Scientists" },
  { id: 33, name: "Suppliers with more than 2 purchases", category: "Purchases" },
  { id: 34, name: "Equipment used more than once", category: "Equipment" },
  { id: 35, name: "Materials requested in quantities greater than 50 in total", category: "Materials" },
  { id: 36, name: "Scientists who made more than 2 requests", category: "Scientists" },
  { id: 37, name: "Gender groups with more than 5 scientists", category: "Scientists" },
  { id: 38, name: "Suppliers who supply more than one material", category: "Suppliers" },
  { id: 39, name: "Find scientists older than average age", category: "Scientists" },
  { id: 40, name: "Find equipment that costs more than the average cost", category: "Equipment" },
  { id: 41, name: "List of scientists who never requested materials", category: "Materials" },
  { id: 42, name: "List suppliers who never supplied materials", category: "Suppliers" },
  { id: 43, name: "Find the most expensive equipment", category: "Equipment" },
  { id: 44, name: "Find scientists in department with highest number of scientists", category: "Scientists" },
  { id: 45, name: "Find material with highest total requests", category: "Materials" },
  { id: 46, name: "Find department with highest equipment cost", category: "Equipment" },
  { id: 47, name: "Find scientists with no equipment assigned", category: "Equipment" },
  { id: 48, name: "Find suppliers with the highest purchases", category: "Purchases" },
  { id: 49, name: "Find specialization with most scientists", category: "Scientists" },
  { id: 50, name: "Find materials never requested", category: "Materials" },
];
...
export default function QueriesReports() {
  ...
  useEffect(() => {
    apiGet<Array<{ id: number; name: string; category?: string }>>('/queries')
      .then((rows) => {
        if (rows.length === 0) {
          return;
        }
